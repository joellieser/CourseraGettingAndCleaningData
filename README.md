...
### COMMENT: You can validate the results by running the following query:
### sqldf("select subject, activity_description, tbodyacc_mean_x, tbodyacc_mean_y FROM tidy_means WHERE subject IN (1,2) ORDER BY subject")
